    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                            ...
                            <tr wire:key="customer-{{ $customer->id }}" 
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <button wire:click.prevent="confirmDelete({{ $customer->id }})" 
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div class="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-md">
                <h3 class="text-lg font-bold text-center mb-4">Hapus Pelanggan?</h3>
                <p class="text-center mb-6">Apakah Anda yakin ingin menghapus Pelanggan ini? Data yang dihapus tidak dapat dikembalikan.</p>
