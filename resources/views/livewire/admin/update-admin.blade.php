        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
            ...
            <form wire:submit.prevent="update" class="p-8 space-y-6">
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                type="text" 
                                wire:model="username" 
                                class="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all duration-200 @error('username') border-red-500 @enderror"
                            >
                        </div>
                ...
                <div class="group">
                    ...
                    <select 
                        wire:model="role_id"
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all duration-200 cursor-pointer @error('role_id') border-red-500 @enderror"
                    >
