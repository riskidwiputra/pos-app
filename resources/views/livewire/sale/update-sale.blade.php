<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-6 px-4">
    <div class="max-w-6xl mx-auto">
        ...
        {{-- Header --}}
        <div class="mb-6">
            <a href="{{ route('sale.index') }}" class="inline-flex items-center gap-2 text-indigo-600 hover:text-indigo-700 font-semibold mb-4 group text-sm">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Invoice: {{ $sale->invoice_number }}</p>
                </div>
            </div>
            ...
            @if(session()->has('error'))
                <div class="mt-4 rounded-xl bg-red-50 border border-red-200 p-3">
                    <div class="flex items-center gap-2">
                                ...
                                <div wire:key="item-{{ $index }}" class="p-4 border-2 border-gray-200 rounded-xl hover:border-indigo-300 transition">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <select wire:model="items.{{ $index }}.product_id" wire:change="setPrice({{ $index }})"  class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:border-indigo-500 @error('items.'.$index.'.product_id') border-red-500 @enderror">
                                        ...
                                        <div>
                                            ...
                                            <div class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-gray-100">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" wire:model="items.{{ $index }}.quantity" wire:change="setSubtotal({{ $index }})" placeholder="1" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:border-indigo-500 @error('items.'.$index.'.quantity') border-red-500 @enderror">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200 sticky top-8">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex justify-between items-center">
                                    ...
                                    <span class="text-xl font-bold {{ $change_amount > 0 ? 'text-green-600' : 'text-gray-600' }}">
                            ...
                            <div class="space-y-3 pt-4">
                                <button type="submit" class="w-full px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105">
