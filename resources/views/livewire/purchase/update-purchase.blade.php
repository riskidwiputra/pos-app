        ...
        <div class="mb-8">
            ...
            <div class="flex items-center gap-4 mb-2">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Kode: {{ $purchase->purchase_code }}</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="group">
                                ...
                                <select wire:model="status" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 cursor-pointer @error('status') border-red-500 @enderror">
                                ...
                                <div wire:key="item-{{ $index }}" class="p-4 border-2 border-gray-200 rounded-xl hover:border-indigo-300 transition">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" wire:model.live="items.{{ $index }}.harga_beli" placeholder="0" step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:border-indigo-500 @error('items.'.$index.'.harga_beli') border-red-500 @enderror">
